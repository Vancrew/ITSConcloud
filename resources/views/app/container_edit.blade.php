...
<div class="row">
  <div class="col-md-12 col-sm-12">
    <div class="box box-primary">
      ...
      <div class="box-body">
        <form data-parsley-validate class="form-horizontal form-label-left" method="post" action="/container/{{$container->id_con}}">
          {{ method_field('PUT') }}
          {{csrf_field()}}
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6">
              <input type="text" name="namerepo"  class="form-control col-md-7">
            </div>
          </div>
